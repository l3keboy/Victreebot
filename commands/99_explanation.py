...
async def command_explanation_raid(ctx: tanjun.abc.Context):
    ...
    explanation_raid_page_5 = (
        hikari.Embed(
            ...
            .add_field(name=lang.explanation_raid_page_5_field_3_title, value=lang.explanation_raid_page_5_field_3_value.format(bot_name=BOT_NAME), inline=False)
    )
...
@explanation_group.with_command
@tanjun.as_slash_command("profile", "Send the explanation of profile to your DM.")
async def command_explanation_profile(ctx: tanjun.abc.Context):
    try:
        lang, auto_delete_time = await get_settings.get_language_auto_delete_time_settings(guild_id=ctx.guild_id)
        log_channel_id = await get_settings.get_log_channel_settings(guild_id=ctx.guild_id)
    except TypeError as e:
    ...
    try:
        channel = await ctx.rest.fetch_channel(channel=log_channel_id)
        await channel.send(lang.log_channel_explanation_profile_sending.format(datetime=datetime.datetime.now().strftime('%d-%m-%Y %H:%M:%S'), member=ctx.member))
    except Exception as e:
        LoggingHandler.LoggingHandler().logger_victreebot_logger.error(f"Something went wrong while trying to send to log channel for guild_id: {ctx.guild_id}!")

    bot_member = await ctx.rest.fetch_my_user()
    # SEND TO EXPLANATION CHANNEL
    explanation_profile_page_1 = (
        hikari.Embed(
            title=lang.explanation_profile_page_1_title,
            description=lang.explanation_profile_page_1_description
        )
            .set_author(name=lang.explanation_author, icon=bot_member.avatar_url)
            .set_footer(
            text=lang.explanation_embed_footer
    ...
    explanation_profile_page_2 = (
        hikari.Embed(
            title=lang.explanation_profile_page_2_title,
            description=lang.explanation_profile_page_2_description
        )
            .set_author(name=lang.explanation_author, icon=bot_member.avatar_url)
            .set_footer(
            text=lang.explanation_embed_footer
            ...
            .set_thumbnail()
            .add_field(name=lang.explanation_profile_page_2_field_1_title, value=lang.explanation_profile_page_2_field_1_value, inline=False)
    )

    explanation_profile_page_3 = (
        hikari.Embed(
            title=lang.explanation_profile_page_3_title,
            description=lang.explanation_profile_page_3_description
        )
            .set_author(name=lang.explanation_author, icon=bot_member.avatar_url)
            .set_footer(
            text=lang.explanation_embed_footer
            ...
            .set_thumbnail()
            .add_field(name=lang.explanation_profile_page_3_field_1_title, value=lang.explanation_profile_page_3_field_1_value, inline=False)
    )

    explanation_profile_page_4 = (
        hikari.Embed(
            title=lang.explanation_profile_page_4_title,
            description=lang.explanation_profile_page_4_description
        )
            .set_author(name=lang.explanation_author, icon=bot_member.avatar_url)
            .set_footer(
            text=lang.explanation_embed_footer
            ...
            .set_thumbnail()
            .add_field(name=lang.explanation_profile_page_4_field_1_title, value=lang.explanation_profile_page_4_field_1_value, inline=False)
    )

    explanation_profile_page_5 = (
        hikari.Embed(
            title=lang.explanation_profile_page_5_title,
            description=lang.explanation_profile_page_5_description
        )
            .set_author(name=lang.explanation_author, icon=bot_member.avatar_url)
            .set_footer(
            text=lang.explanation_embed_footer
            ...
            .set_thumbnail()
            .add_field(name=lang.explanation_profile_page_5_field_1_title, value=lang.explanation_profile_page_5_field_1_value, inline=False)
    )

    values = [explanation_profile_page_1, explanation_profile_page_2, explanation_profile_page_3, explanation_profile_page_4, explanation_profile_page_5]
    ...
    try:
        ...
        try:
            channel = await ctx.rest.fetch_channel(channel=log_channel_id)
            await channel.send(lang.log_channel_explanation_profile_sending_failed.format(datetime=datetime.datetime.now().strftime('%d-%m-%Y %H:%M:%S'), member=ctx.member))
        except Exception as e:
            LoggingHandler.LoggingHandler().logger_victreebot_logger.error(f"Something went wrong while trying to send to log channel for guild_id: {ctx.guild_id}!")
...
@explanation_group.with_command
@tanjun.as_slash_command("stats", "Send the explanation of stats to your DM.")
async def command_explanation_raid(ctx: tanjun.abc.Context):
    try:
        lang, auto_delete_time = await get_settings.get_language_auto_delete_time_settings(guild_id=ctx.guild_id)
        log_channel_id = await get_settings.get_log_channel_settings(guild_id=ctx.guild_id)
    ...
    try:
        channel = await ctx.rest.fetch_channel(channel=log_channel_id)
        await channel.send(lang.log_channel_explanation_stats_sending.format(datetime=datetime.datetime.now().strftime('%d-%m-%Y %H:%M:%S'), member=ctx.member))
    except Exception as e:
        LoggingHandler.LoggingHandler().logger_victreebot_logger.error(f"Something went wrong while trying to send to log channel for guild_id: {ctx.guild_id}!")

    bot_member = await ctx.rest.fetch_my_user()
    # SEND TO EXPLANATION CHANNEL
    explanation_stats_page_1 = (
        hikari.Embed(
            title=lang.explanation_stats_page_1_title,
            description=lang.explanation_stats_page_1_description
        )
            .set_author(name=lang.explanation_author, icon=bot_member.avatar_url)
            .set_footer(
            text=lang.explanation_embed_footer
    ...
    explanation_stats_page_2 = (
        hikari.Embed(
            title=lang.explanation_stats_page_2_title,
            description=lang.explanation_stats_page_2_description
        )
            .set_author(name=lang.explanation_author, icon=bot_member.avatar_url)
            .set_footer(
            text=lang.explanation_embed_footer
            ...
            .set_thumbnail()
            .add_field(name=lang.explanation_stats_page_2_field_1_title, value=lang.explanation_stats_page_2_field_1_value, inline=False)
    )

    explanation_stats_page_3 = (
        hikari.Embed(
            title=lang.explanation_stats_page_3_title,
            description=lang.explanation_stats_page_3_description
        )
            .set_author(name=lang.explanation_author, icon=bot_member.avatar_url)
            .set_footer(
            text=lang.explanation_embed_footer
            ...
            .set_thumbnail()
            .add_field(name=lang.explanation_stats_page_3_field_1_title, value=lang.explanation_stats_page_3_field_1_value, inline=False)
    )

    explanation_stats_page_4 = (
        hikari.Embed(
            title=lang.explanation_stats_page_4_title,
            description=lang.explanation_stats_page_4_description
        )
            .set_author(name=lang.explanation_author, icon=bot_member.avatar_url)
            .set_footer(
            text=lang.explanation_embed_footer
            ...
            .set_thumbnail()
            .add_field(name=lang.explanation_stats_page_4_field_1_title, value=lang.explanation_stats_page_4_field_1_value.format(bot_name=BOT_NAME), inline=False)
            .add_field(name=lang.explanation_stats_page_4_field_2_title, value=lang.explanation_stats_page_4_field_2_value.format(bot_name=BOT_NAME), inline=False)
    )

    values = [explanation_stats_page_1, explanation_stats_page_2, explanation_stats_page_3, explanation_stats_page_4]
    ...
    try:
        ...
        try:
            channel = await ctx.rest.fetch_channel(channel=log_channel_id)
            await channel.send(lang.log_channel_explanation_stats_sending_failed.format(datetime=datetime.datetime.now().strftime('%d-%m-%Y %H:%M:%S'), member=ctx.member))
        except Exception as e:
            LoggingHandler.LoggingHandler().logger_victreebot_logger.error(f"Something went wrong while trying to send to log channel for guild_id: {ctx.guild_id}!")
...
@explanation_group.with_command
@tanjun.as_slash_command("trade", "Send the explanation of stats to your DM.")
async def command_explanation_raid(ctx: tanjun.abc.Context):
    try:
        lang, auto_delete_time = await get_settings.get_language_auto_delete_time_settings(guild_id=ctx.guild_id)
        log_channel_id = await get_settings.get_log_channel_settings(guild_id=ctx.guild_id)
    ...
    bot_member = await ctx.rest.fetch_my_user()
    # SEND TO EXPLANATION CHANNEL
    explanation_trade_page_1 = (
        hikari.Embed(
            title=lang.explanation_trade_page_1_title,
            description=lang.explanation_trade_page_1_description
        )
            .set_author(name=lang.explanation_author, icon=bot_member.avatar_url)
            .set_footer(
            text=lang.explanation_embed_footer
    ...
    explanation_trade_page_2 = (
        hikari.Embed(
            title=lang.explanation_trade_page_2_title,
            description=lang.explanation_trade_page_2_description
        )
            .set_author(name=lang.explanation_author, icon=bot_member.avatar_url)
            .set_footer(
            text=lang.explanation_embed_footer
            ...
            .set_thumbnail()
            .add_field(name=lang.explanation_trade_page_2_field_1_title, value=lang.explanation_trade_page_2_field_1_value, inline=False)
    )

    explanation_trade_page_3 = (
        hikari.Embed(
            title=lang.explanation_trade_page_3_title,
            description=lang.explanation_trade_page_3_description
        )
            .set_author(name=lang.explanation_author, icon=bot_member.avatar_url)
            .set_footer(
            text=lang.explanation_embed_footer
            ...
            .set_thumbnail()
            .add_field(name=lang.explanation_trade_page_3_field_1_title, value=lang.explanation_trade_page_3_field_1_value, inline=False)
    )

    explanation_trade_page_4 = (
        hikari.Embed(
            title=lang.explanation_trade_page_4_title,
            description=lang.explanation_trade_page_4_description
        )
            .set_author(name=lang.explanation_author, icon=bot_member.avatar_url)
            .set_footer(
            text=lang.explanation_embed_footer
            ...
            .set_thumbnail()
            .add_field(name=lang.explanation_trade_page_4_field_1_title, value=lang.explanation_trade_page_4_field_1_value, inline=False)
    )

    values = [explanation_trade_page_1, explanation_trade_page_2, explanation_trade_page_3, explanation_trade_page_4]
