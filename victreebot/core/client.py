...
class Client(tanjun.Client):
    ...
    @classmethod
    def from_gateway_bot(cls, bot: hikari.GatewayBotAware, /, *, event_managed: bool = True, mention_prefix: bool = False, declare_global_commands: t.Union[hikari.Snowflake, bool] = False) -> "Client":
